...
ann_file_train = '/mnt/ext3/View3/train_3rd_view3.txt'
ann_file_val = '/mnt/ext3/View3/val_3rd_view3.txt'
ann_file_test = '/mnt/ext3/View3/val_3rd_view3.txt'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/mnt/ext3/View3/train_3rd_view3.txt',
    ...
    val=dict(
        type='RawframeDataset',
        ann_file='/mnt/ext3/View3/val_3rd_view3.txt',
        data_prefix='/workspace/DATASET/Tmax/CarAccident/view1',
        pipeline=[
            dict(
                type='SampleFrames',
...
lr_config = dict(
    ...
    warmup_iters=1)
total_epochs = 25
work_dir = 'mnt/ext3/server1/For3_view3'
